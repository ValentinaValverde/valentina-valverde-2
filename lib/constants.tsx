export const featuredWorkData = [
  ...
  },
  {
    ...
    link: '/projects/rabbit-hole-digital',
...
export const moreProjectData = [
  {
    ...
    challenges: [
      ...
      'Convincing stakeholders (product, engineering, sales) to devote time and development resources to a large-scale redesign of our most strategic surface — balancing feature delivery vs. UX debt reduction.',
      'Ensuring the redesign both improved the “time to live” (user launches an app) and supported retention and monetization metrics, so we could clearly quantify its impact and sell the effort internally.',
    ],
    wins: [
  ...
  },
  {
    ...
    challenges: [
      'Determining the most effective ways to visualize data and deciding which formats (pie charts, bar graphs, etc.) best communicated different types of information.',
      'Encouraging the team to invest time in a complete refactor. As a young startup, balancing priorities and development time was a key challenge.',
      'Presenting and pitching the final redesign to stakeholders in a clear and compelling way.',
    ],
    wins: [
